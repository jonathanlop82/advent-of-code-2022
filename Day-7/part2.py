...
unused = 70000000 - sumtotal
print(f'Unused: {unused}')

requiered = 30000000 - unused

print(f'Requiered to detele: {requiered}')

dirs_sorted = {k: v for k, v in sorted(dirs.items(), key=lambda item: item[1])}

print(dirs_sorted)

total = 0
for k in dirs_sorted:
    if dirs[k] >= requiered:
        print(f'{k} = {dirs[k]}')
        break
